...
public class WechatService {
    ...
    public String getAccessToken() {
        ...
        WeChatAccessTokenVO accessToken = JacksonUtil.parseObject(sync, WeChatAccessTokenVO.class);
        // 响应数据
    ...
    public WeChatSessionKeyVO getSessionKeyOrOpenId(String code) {
        ...
        // 请求接口
        String sync = OkHttpUtil.builder().url(url).get().sync();
        WeChatSessionKeyVO sessionKey = JacksonUtil.parseObject(sync, WeChatSessionKeyVO.class);
        // 响应数据
    ...
    public String getUserPhoneNumber(String accessToken, String code) {
        ...
        JsonNode rootNode = JacksonUtil.parseObject(sync, JsonNode.class);
