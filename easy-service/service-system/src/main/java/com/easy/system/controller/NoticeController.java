...
public class NoticeController {
    ...
    @SaCheckPermission(type = StpAdminUtil.TYPE, value = "system.msg.page", orRole = Constants.ADMIN_ROLE)
    ...
    @SaCheckPermission(type = StpAdminUtil.TYPE, value = "system.msg.add", orRole = Constants.ADMIN_ROLE)
    ...
    @SaCheckPermission(type = StpAdminUtil.TYPE, value = "system.msg.update", orRole = Constants.ADMIN_ROLE)
    ...
    @SaCheckPermission(type = StpAdminUtil.TYPE, value = "system.msg.del", orRole = Constants.ADMIN_ROLE)
